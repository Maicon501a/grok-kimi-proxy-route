...
export function AccioCredits() {
  return window['go']['main']['App']['AccioCredits']();
}

export function AccioManagerStatus() {
  return window['go']['main']['App']['AccioManagerStatus']();
}

export function AccioStatus() {
  return window['go']['main']['App']['AccioStatus']();
}

export function AccioTopUpNow() {
  return window['go']['main']['App']['AccioTopUpNow']();
}
...
export function SetAccioManagerConfig(arg1, arg2, arg3) {
  return window['go']['main']['App']['SetAccioManagerConfig'](arg1, arg2, arg3);
}
